    ...
    <form action="01AriketaPOST.php" method="post">
      <fieldset>
        ...
        <div class="form">
          ...
          <div>
            <label for="ec">Estado civil: </label><br />
            <input type="radio" value="soltero" name="ec" /> Soltero
            <input type="radio" value="casado" name="ec" /> Casado
            <input type="radio" value="otro" name="ec" /> Otro
          </div>
        </div>

        <div id="formLast">
          <div>
            <label for="afi">Aficiones: </label>
          </div>
          <div>
